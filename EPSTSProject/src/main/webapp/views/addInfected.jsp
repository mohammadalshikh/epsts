        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control border border-warning" required name="name"
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control border border-warning" required name="weight" min="1"
                           placeholder="Weight">
                </div>
                <div class="form-group">
                    <label for="weight">Available Quantity</label>
                    <input type="number" class="form-control border border-warning" required name="quantity" min="1"
            ...
            <div class="col-sm-5"><br>
                <div class="form-group">
                    ...
                    <textarea class="form-control border border-warning" rows="4" name="description"
                              placeholder="Product Details" value="no product details"></textarea>
                </div>
                <p>Product Image</p>
                <div class="custom-file">
                    <input type="text" class="form-control border border-warning" required name="productImage"
                           id="productImage" placeholder="Enter image link">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="input" class="form-control border border-warning" required name="discount" min="0"
