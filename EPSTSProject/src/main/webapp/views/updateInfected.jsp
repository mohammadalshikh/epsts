        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control border border-success" required name="name" value="${pname }"
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control border border-success" required name="quantity"
                           value="${ pquantity }" min="1" placeholder="Quantity">
                </div>
            ...
            <div class="col-sm-5">
                ...
                <div class="custom-file">
                    <input type="text" class="form-control border border-success" required name="productImage"
                           placeholder="Enter image link" value="${ pimage }">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="input" class="form-control border border-success" required name="discount"
                           value="${ pdiscount }" min="0" max="1" step="any" placeholder="Discount">
                </div>
