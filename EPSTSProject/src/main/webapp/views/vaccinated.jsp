...
<br>
<div style="margin-right: 50px" class="d-flex justify-content-end mb-3">
    <button type="button" style="margin: 20px 0" class="btn btn-action" data-toggle="modal" data-target="#exampleModalCenter">Add new entry</button>
</div>
<div class="container">
